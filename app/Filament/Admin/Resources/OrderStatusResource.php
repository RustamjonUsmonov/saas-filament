...
class OrderStatusResource extends Resource
{
    ...
    {
        return [
            'index' => \App\Filament\Admin\Resources\OrderStatusResource\Pages\ListOrderStatuses::route('/'),
            'edit' => \App\Filament\Admin\Resources\OrderStatusResource\Pages\EditOrderStatus::route('/{record}/edit'),
        ];
    }
}
