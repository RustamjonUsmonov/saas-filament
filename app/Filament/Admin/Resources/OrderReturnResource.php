...
class OrderReturnResource extends Resource
{
    ...
    {
        return [
            'index' => \App\Filament\Admin\Resources\OrderReturnResource\Pages\ListOrderReturns::route('/'),
            'create' => \App\Filament\Admin\Resources\OrderReturnResource\Pages\CreateOrderReturn::route('/create'),
            'edit' => \App\Filament\Admin\Resources\OrderReturnResource\Pages\EditOrderReturn::route('/{record}/edit'),
        ];
    }
}
