        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            @foreach($records as $record)
                <div
                    ...
                    <x-filament::section :icon="'phosphor-hash'" :icon-color="'primary'" :class="'mx-4 px-2'" :heading="$record->name">
                        {{--<div class="px-6 pb-6">
                            <x-filament::button :href="route('filament.admin.resources.product-tags.edit', $record->id)"
